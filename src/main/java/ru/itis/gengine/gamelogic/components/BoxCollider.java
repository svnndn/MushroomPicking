...
public class BoxCollider extends Component {
    ...
    public boolean isColliding(BoxCollider otherCollider) {
        float minX = getMinX();
        float maxX = getMaxX();
        float minY = getMinY();
        float maxY = getMaxY();

        float otherMinX = otherCollider.getMinX();
        float otherMaxX = otherCollider.getMaxX();
        float otherMinY = otherCollider.getMinY();
        float otherMaxY = otherCollider.getMaxY();
